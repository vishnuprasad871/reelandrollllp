        ...
        <div class="container">
            ...
            <div id="wedding" style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center; margin-bottom: 8rem;">
                ...
                <div class="reveal">
                    ...
                    <a href="/contact?service=wedding" class="btn btn-primary" style="margin-top:2rem;"><span>Get A Quote</span></a>
                </div>
            </div>
            ...
            <div id="portrait" style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center; margin-bottom: 8rem;">
                <div class="reveal">
                    ...
                    <a href="/contact?service=portrait" class="btn btn-primary" style="margin-top:2rem;"><span>Get A Quote</span></a>
                </div>
                <div class="reveal">
            ...
            <div id="event" style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center; margin-bottom: 8rem;">
                ...
                <div class="reveal">
                    ...
                    <a href="/contact?service=event" class="btn btn-primary" style="margin-top:2rem;"><span>Get A Quote</span></a>
                </div>
            </div>
            ...
            <div id="landscape" style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center; margin-bottom: 8rem;">
                <div class="reveal">
                    ...
                    <a href="/contact?service=landscape" class="btn btn-primary" style="margin-top:2rem;"><span>Inquire Now</span></a>
                </div>
                <div class="reveal">
            ...
            <div id="sports" style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center; margin-bottom: 8rem;">
                ...
                <div class="reveal">
                    ...
                    <a href="/contact?service=sports" class="btn btn-primary" style="margin-top:2rem;"><span>Get in Touch</span></a>
                </div>
            </div>
            ...
            <div id="corporate" style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center; margin-bottom: 8rem;">
                <div class="reveal">
                    ...
                    <a href="/contact?service=corporate" class="btn btn-primary" style="margin-top:2rem;"><span>Get A Quote</span></a>
                </div>
                <div class="reveal">
